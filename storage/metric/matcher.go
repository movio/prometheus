...
//
// The score is based on a pretty bad but still quite helpful heuristics for now:
//
// - A matcher that matches nothing has a score of 0.
//
...
func (m *LabelMatcher) calculateScore() {
	...
	case model.BucketLabel, model.QuantileLabel:
		// Magic labels for buckets and quantiles will match coupiously.
		m.score = 0.5
